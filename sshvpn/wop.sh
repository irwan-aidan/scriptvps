...
deb-src http://packages.dotdeb.org atretch all
END2
...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/wangzki03/premscript/master/screenfetch"
...
wget -O /etc/stunnel/stunnel.pem "https://raw.githubusercontent.com/wangzki03/premscript/master/updates/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/wangzki03/premscript/master/req/stunnel.conf"
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/wangzki03/premscript/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/wangzki03/premscript/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/wangzki03/premscript/master/mrtg.conf" >> /etc/mrtg.cfg
...
# OpenVPN Configuration by Wangzki
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/wangzki03/premscript/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/wangzki03/premscript/master/badvpn-udpgw64"
fi
...
# download script
cd
wget https://raw.githubusercontent.com/wangzki03/premscript/master/install-premiumscript.sh -O - -o /dev/null|sh
