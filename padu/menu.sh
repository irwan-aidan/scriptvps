...
;;
28)
rm -rf paket.sh && apt install curl && wget https://raw.githubusercontent.com/dpvpn09/dpvpn3/main/menu-all/paket.sh && apt install dos2unix && dos2unix paket.sh && chmod +x paket.sh && ./paket.sh
;;
29)
